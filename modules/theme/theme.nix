...
in
{
  options.vim.theme = {
    ...
    name = mkOption {
      ...
      description = ''Name of theme to use: "catppuccin" "nightfox" "onedark" "rose-pine" "tokyonight" "gruber-darker"'';
    };
    ...
    in
    {
      ...
      vim.startPlugins =
        ...
        (
          ...
          ++ (withPlugins (cfg.name == "gruber-darker") [ gruber-darker ])
        );
      ...
      vim.luaConfigRC = ''
        ...
        ${writeIf (cfg.name == "gruber-darker") ''
          -- Gruber Darker theme
